        ...
        <div>
          <div className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-3 py-1">
            ...
            <span className="font-mono text-xs text-muted-foreground">
              Low-gas alerts are now live
            </span>
          </div>

          <h1 className="mt-6 text-balance text-4xl font-semibold leading-[1.05] tracking-tight sm:text-5xl lg:text-6xl">
            Stop burning money on crypto{" "}
            <span className="text-primary">gas fees</span>.
          </h1>

          <p className="mt-6 max-w-lg text-pretty text-lg leading-relaxed text-muted-foreground">
            ClaimFees monitors gas fees across every blockchain network in real time,
            predicts the lowest-cost windows, and alerts you when it&apos;s time to transact.
          </p>
